...
export default function AtualizacaoEscoltaArmadaPage() {
  return (
    <>
      <main className={styles.main}>
        <div className={styles.header}>
          <div className={styles.headerText}>
            <h1>Atualização Escolta Armada (Antiga Reciclagem)</h1>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.content}>
            ...
            <p>Mantenha-se atualizado em prevenção, reação e uso de armamentos em escoltas.</p>
            <p>
              Treinamento de atualização para profissionais de escolta armada. Enfoque em técnicas preventivas, reação a
              ataques e prática com armamentos específicos, garantindo atuação eficiente e dentro das normas da
              segurança privada.
            </p>
            ...
            <p>
              <ul>
                ...
                <li>Cópia do Certificado do Curso de Extensão em Escolta Armada (Frente e Verso)</li>
